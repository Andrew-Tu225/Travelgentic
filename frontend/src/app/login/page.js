...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(200,169,110,0.07),transparent_70%),#100e0b] px-4 py-8 font-sans">
      ...
      {/* Auth Card */}
      <div className="w-full max-w-[440px] rounded-[18px] border border-white/[0.07] bg-white/[0.03] p-7 backdrop-blur-[20px] sm:p-8">
        ...
        <Reveal delay={120}>
          ...
          <div className="mt-4">
            <PrimaryBtn onClick={handleSubmit} disabled={!email || !password}>
